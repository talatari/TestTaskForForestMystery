...
public class HeroController : MonoBehaviour
{
    ...
    private void FixUpdate()
    {
        ...
        if (Input.GetKey(KeyCode.Space) == true || (Input.GetKey(KeyCode.W) == true))
        {
            JumpHero();
        }
    ...
    private void MoveHero()
    {
        ...
        _heroRigidBody.velocity = new Vector2(_speed, _heroRigidBody.velocity.y);
    ...
    private void JumpHero()
    {
        ...
        {
            _heroRigidBody.velocity = new Vector2(_heroRigidBody.velocity.x, _heroJumpPower);
        }
    }
